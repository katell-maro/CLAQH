		...
		<div class="voletContainer container">
			<div class="row">
				...
				<div class="contenu col-md-10 col-sm-10 col-xs-10">
					...
					<h2> Objectifs</h2>
					<p class="texteVolet">
						Le Hg tend à s'accumuler dans les sédiments dans lesquels certaines bactéries anaérobies, principalement les microorganismes sulfato-réducteurs (MSR), le transforment en méthylmercure favorisant son passage dans les chaînes alimentaires. Certaines données récentes font également état de la présence de ces MSR au niveau des racines de plantes aquatiques dans la colonne d'eau. Récemment deux gènes, hgcA et hgcB, ont été identifiés comme intervenant dans la méthylation du Hg chez les MSR.
					</p>

					<p class="texteVolet">
						Le projet vise à utiliser ces deux gènes comme marqueur de la méthylation potentielle du Hg in situ. Il s’agit d’établir la cartographie de ces marqueurs dans les différents compartiments du milieu (sédiments, périphytons associés aux plantes, colonne d’eau, flore intestinale des poissons …) et d’effectuer de nombreuses analyses (extraction de l’ADN génomique et séquençage dans l’ensemble des compartiments). Ceci permettra de générer des données qualitatives, et de comparer la diversité de ces gènes aux mesures d’activités de méthylation.
					</p>

					<p class="texteVolet">
						Enfin, une analyse quantitative peut être réalisée pour contribuer à l’estimation des activités de méthylation microbienne en fonction des paramètres environnementaux.
					</p>

					<p class="texteVolet">
						Ces travaux vont permettre de comprendre d’où provient le méthylmercure présent dans la chair des poissons carnassiers et de le tracer sur son lieu de fabrication (biofilm, interface eau-sédiment…).
					</p>
