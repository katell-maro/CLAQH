			...
			<div class="row">
				...
				<div class="contenu col-md-10 col-sm-10 col-xs-10">
					...
					<p class="texteVolet">
          			...
          			<p class="texteVolet">
          				Des études récentes montrent que la signature isotopique apporte des informations précieuses sur les mécanismes d’accumulation dans les réseaux trophique. Ainsi, certains travaux montrent que le Hg(II) et le MeHg peuvent ne pas avoir la même signature isotopique.
          			</p>

          			<p class="texteVolet">
          				Le volet 3 consiste dans un premier temps à déterminer la composition isotopique du Hg dans les muscles de poissons prélevés dans le volet 1, ainsi que dans les différents compartiments environnementaux récepteurs des sources de Hg et sites potentiels pour la méthylation (sédiments, plantes, périphyton). Ces données permettront de déterminer l’origine du Hg dans ces poissons qui reste inconnue à ce jour dans les lacs aquitains.
          			</p>

          			<p class="texteVolet">
          				Dans un second temps, la composition isotopique de chaque forme du Hg sera déterminée dans une sélection de tissus pertinents (muscle, foie…) afin de mieux comprendre les processus de métabolisation et de bioamplification dans le réseau trophique et de tracer l’origine du Hg.
          			</p>
