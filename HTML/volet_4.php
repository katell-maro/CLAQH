    ...
    <?php include_once 'navigation.html'; ?>
		...
		<div class="voletContainer container">
            ...
            <a href="volet_3.php">Volet 3</a>
						<a href="volet_4.php" class="active">Volet 4</a>
				...
				<div class="col-md-10 col-sm-10 col-xs-10">
					<h1>Évaluer la couverture de la végétation aquatique pour quantifier la production de Méthylmercure</h1>
					<p class="texteVolet">

          </p>

					<h2>Équipe de recherche en charge du volet 4 :</h2>
					<p class="equipeVolet">
						Irstea, EABX, équipe CARMA.
						<br/>
						Cristina Ribaudo et Vincent Bertrin
					</p>
